  ...
  return (
    <div className="space-y-8 relative px-6 py-10">
      ...
      <div className="pointer-events-none absolute inset-0 -z-10">
        ...
        <div className="absolute top-40 -right-10 h-72 w-72 rounded-full bg-indigo-600/10 blur-3xl" />
      </div>
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <div className="flex-1 space-y-2">
          ...
          <div className="h-3 w-1/5 rounded skeleton" />
        </div>
      </div>

      {/* Welcome banner shimmer */}
      <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-8 shadow-lg space-y-4">
        <div className="h-4 w-1/3 rounded skeleton" />
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {[...Array(3)].map((_, i) => (
          <div
            key={i}
            className="h-32 rounded-2xl border border-white/10 bg-white/[0.04] skeleton"
          />
        ))}
      </div>

      {/* Secondary row shimmer */}
      <div className="grid gap-4 lg:grid-cols-3">
        {[...Array(3)].map((_, i) => (
          <div
            key={i}
            className="h-[130px] rounded-2xl border border-white/10 bg-white/[0.04] skeleton"
          />
        ))}
      </div>
    </div>
